...
The code in [data.py](main/data.py) automatically resolves paths relative to the project root, so CSV paths like `./Dataset/AIGCIQA2023/image.jpg` will work correctly.
...
**Generated by**: [train.py](main/train.py) `train_model()` function
...
**Generated by**: [pruning.py](main/Utils/pruning.py) `FeatureMapsPruner` class
...
**Generated by**: [explainability.py](main/Utils/explainability.py) - `GradCAM` and `MultiscalePixelMasking`
...
**Experiment 1** ([experiment_one.py](main/Experiments/experiment_one.py)):
...
**Experiment 2** ([experiment_two.py](main/Experiments/experiment_two.py)):
...
**Experiment 3** ([experiment_three.py](main/Experiments/experiment_three.py)) - WIP:
...
1. **Verify dataset structure**:
   ...
   ```
2. **Check CSV paths**: The `ImageAuthenticityDataset` in [data.py](main/data.py) expects paths relative to project root
...
1. **Check GPU availability**:
   ...
   ```
2. **Reduce batch size**: Lower `BATCH_SIZE` in [data.py](main/data.py) from 64 to 32 or 16
...
- **[EXPERIMENT_1_TECHNICAL_REPORT.md](main/Experiments/EXPERIMENT_1_TECHNICAL_REPORT.md)**: Detailed report on Experiment 1
- **[EXPERIMENT_2_TECHNICAL_REPORT.md](main/Experiments/EXPERIMENT_2_TECHNICAL_REPORT.md)**: Detailed report on Experiment 2
- **[EXPERIMENT_3_TECHNICAL_REPORT.md](main/Experiments/EXPERIMENT_3_TECHNICAL_REPORT.md)**: Detailed report on Experiment 3 (ensemble methods)
